...
45 бічних (vertical + void) — всі процедурні, генеруються через той самий пул що і батьківське коло.
...
|--------------------|-----------|--------|-----------|
| pos 3 кожного кола | `vertical` | праворуч | `+100` |
| pos 4 кожного кола | `void`     | ліворуч  | `+100` |
| pos 5 кожного кола | `vertical` | праворуч | `+100` |
| pos 7 кожного кола | `vertical` | праворуч | `+100` |
...
`vertical → vertical → vertical → vertical → vertical → vertical → void → vertical → vertical → boss`

Повторюється для кожного кола. `void` завжди на фіксованих позиціях (4.1, 9.1). Інші бічні рівні (3.1, 5.1, 7.1) — теж `vertical`.
