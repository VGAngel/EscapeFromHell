...
Generated by `tools/gen_synth_sounds.py` (numpy + Python `wave` module) — used
where no asset existed yet. All `.wav`, mono, 44.1 kHz. Replace any of them by
dropping a real `.ogg`/`.mp3` at the same path; SoundManager picks the new file
automatically.

| Path | Sound |
|---|---|
| audio/sfx/player/death_gasp.wav | descending sine sweep 220→70 Hz |
| audio/sfx/player/respawn_breath.wav | ascending sine sweep 180→380 Hz |
| audio/sfx/enemy/alert_grunt.wav | upward ping 600→950 Hz |
| audio/sfx/enemy/chase_growl.wav | descending saw with vibrato |
| audio/sfx/env/water_drip.wav | damped sine pluck @ 820 Hz |
| audio/sfx/env/chain_clank.wav | noise-burst + 380 Hz body |
| audio/sfx/ui/pause_chime.wav | C5 + E5 stacked sine chord |
| audio/sfx/ui/level_complete_chime.wav | C–E–G–C arpeggio |
| audio/sfx/ui/star_soft.wav | A5 sine |
| audio/sfx/ui/star_gold.wav | A5 + E6 stacked |
| audio/sfx/bonus/expiring_tick.wav | 1 kHz square blip |
