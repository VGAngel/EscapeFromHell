...
const REQUIRED_KEYS := [
	...
	"main_menu_dyn.play_continue_short",
	"main_menu_dyn.continue_first_attempt",
	"main_menu_dyn.continue_with_best",
	"main_menu_dyn.continue_new_circle",
	"main_menu_dyn.continue_milestone_50",
	"main_menu_dyn.continue_milestone_99",
	...
	"settings.title",
	"settings.tab_sound",
	"settings.tab_language",
	"settings.tab_graphics",
	"settings.tab_keys",
	...
	"settings.keys_hint",
	"settings.keys_press",
	"settings.keys_reset_all",
	"settings.key_label.move_left",
	"settings.key_label.move_right",
	"settings.key_label.jump",
	"settings.key_label.action",
	"settings.key_label.interact",
	"settings.key_label.look_down",
	"settings.key_label.pray",
	"settings.mobile_section",
	"settings.mobile_size",
	"settings.mobile_edit",
